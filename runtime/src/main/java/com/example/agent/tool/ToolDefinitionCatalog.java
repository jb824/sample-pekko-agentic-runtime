...
public final class ToolDefinitionCatalog {
    ...
    public static Map<String, ToolDefinition> create(ActorContext<ToolProtocol.Command> context, AppConfig config) {
        ...
        ActorRef<ToolProtocol.Command> ragRetrieveTool = context.spawn(
                supervised(RagRetrieveToolActor.create(config)),
                "rag-retrieve-tool"
        );
        register(definitions, RagRetrieveToolActor.class, ragRetrieveTool::tell);
